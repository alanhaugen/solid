...
unsigned long Random::GetRandomSeed() {
...
unsigned long Random::RandomNumber() {
    unsigned long y;
...
unsigned int Random::RandomRange(int minNumber, int maxNumber) {
    return minNumber + (RandomNumber() % (maxNumber - minNumber));
}
